      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            problems. With expertise in modern web technologies, I bring ideas to life through code
            and design.
          </motion.p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          {/* Profile Image — fixed to always be a perfect circle */}
          <motion.div
            variants={fadeLeft}
            initial="hidden"
            animate={isInView ? "visible" : "hidden"}
          ...
          >
            {/* Outer wrapper: square via aspect-ratio, then rounded-full */}
            <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96">
              ...
              />
              {/* Image container — must have explicit equal width & height to stay circular */}
          ...
          >
            <div>
              ...
              <p className="text-white/70 leading-relaxed mb-2">
                I am a dedicated software developer with a strong foundation in building modern,
                scalable, and user-friendly web applications. With experience working in both
                collaborative team environments and as a freelancer, I specialize in turning client
                requirements into sleek, functional, and innovative websites.
              </p>
              <p className="text-white/70 leading-relaxed">
                My passion lies in leveraging the latest technologies to deliver tailored solutions
                that meet unique needs. Whether it&apos;s creating a dynamic web presence for
                businesses or contributing to large-scale development projects, I thrive on solving
                challenges and bringing ideas to life.
              </p>
            </div>
          </motion.div>
        </div>
